...
def get_url_from_response(callback_context: CallbackContext, llm_response: LlmResponse) -> Optional[LlmResponse]:
    ...
    url = match.group(0) if match else "https://revisionbnl.my-oxford.com/cdn/shop/products/1375578.png"

    print(f"Parse JSON Callback modified response from {original_text} to {url}")
