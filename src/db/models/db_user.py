...
class User(Base):
    ...
    hashed_password = Column(String(100), nullable=False) #TODO: true, oauth = NULL
    is_active = Column(Boolean, default=True)
    is_admin = Column(Boolean, default=False) # Added for admin role
    #TODO recognize oauth accs:: open_id = Column(String(50), unique=True, index=True, nullable=True) # New field for OpenID
